...
I created three VMs in VirtualBox: one for Windows Server 2022,
one for Windows 10 (Client1), and one for Windows 11 (Client2).
For the server I allocated 4096MB RAM and 50GB storage.
For each client I allocated 4096MB RAM and 40-50GB storage.
