...
###  2. [Network Infrastructure & Routing](./network-infrastructure)
...
### 3. [Help Desk Operations (osTicket)](./osticket-helpdesk)
...
### 4. [Automation via PowerShell](./powershell-automation)
